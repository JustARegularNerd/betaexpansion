...
public class RenderItem extends Render
{
            ...
            float f, float f1)
    {
        ...
        if(itemstack.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID].getRenderType()))
        {
            ...
            renderManager.renderEngine.bindTexture(BETextureHelper.getTextureFromIdAndMetadata(itemstack.itemID, itemstack.getItemDamage()));
            float f4 = 0.25F;
    ...
    public void drawItemIntoGui(FontRenderer fontrenderer, RenderEngine renderengine, int i, int j, int k, int l, int i1)
    {
        ...
        {
            int j1 = i;
            renderengine.bindTexture(BETextureHelper.getTextureFromIdAndMetadata(i, j));
        ...
        if(k >= 0)
        {
            ...
            renderTexturedQuad(l, i1, (k % 16) * 16, (k / 16) * 16, 16, 16, 16, 16);
    ...
    public void renderTexturedQuad(int i, int j, int k, int l, int i1, int j1, int k1, int l1)
    {
        float f = 0.0F;
        ...
        Tessellator tessellator = Tessellator.instance;
        tessellator.startDrawingQuads();
        tessellator.addVertexWithUV(i + 0, j + j1, f, (float)(k + 0) * f1, (float)(l + l1) * f2);
        tessellator.addVertexWithUV(i + i1, j + j1, f, (float)(k + k1) * f1, (float)(l + l1) * f2);
        tessellator.addVertexWithUV(i + i1, j + 0, f, (float)(k + k1) * f1, (float)(l + 0) * f2);

    ...
    public boolean onItemUse(ItemStack itemstack, EntityPlayer entityplayer, World world, int i, int j, int k, int l)
    {
        ...
        if(l != 0 && j1 == 0 && i1 == Block.grass.blockID || i1 == Block.dirt.blockID)
        {
            ...
            } else
            {
            	...
            	{
            	case 1: n = BEBlocks.tilledFieldDry.blockID; break;
            	case 2: n = BEBlocks.tilledFieldCool.blockID; break;
            	case 3: n = BEBlocks.tilledFieldWarm.blockID; break;
            	}
                world.setBlockWithNotify(i, j, k, n);

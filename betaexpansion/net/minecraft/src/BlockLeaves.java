...
implements ITexInfo
{
    ...
    public void setGraphicsLevel(boolean flag)
    {
        ...
        ((BlockAppleLeaves)BEBlocks.appleLeaves).setGraphicsLevel(flag);
    }
    ...
    {
    	if(i == 18 && world.worldInfo.getSeason() == 3 && (j & 3) == 0)
    	{
    		return 2;
    	}
    	if(i == BEBlocks.appleLeaves.blockID)
    	{
    		return 2;
    	}
    	return 0;
    }
    protected int baseIndexInPNG;

...
public class GuiDetails extends GuiScreen
{
    ...
    public GuiDetails(GuiScreen guiscreen, GameSettings gamesettings)
    {
        field_22107_a = "Details";
    ...
    static 
    {
        field_22108_k = (new EnumOptions[] {
            EnumOptions.G_CLOUDS, EnumOptions.G_GRASS, EnumOptions.G_VIGNETTE, EnumOptions.G_LEAVES, EnumOptions.G_SHADOWS
        });
    }
}

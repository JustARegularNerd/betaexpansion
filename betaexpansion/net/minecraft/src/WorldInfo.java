...
public class WorldInfo
{
    ...
    public WorldInfo(NBTTagCompound nbttagcompound)
    {
        ...
        season = nbttagcompound.getInteger("season");
        seasonLength = nbttagcompound.getInteger("seasonLength");
        seasonOffset = nbttagcompound.getInteger("seasonOffset");
        beVersion = nbttagcompound.getInteger("beVersion");
    }
    ...
    public WorldInfo(WorldInfo worldinfo)
    {
        ...
        season = worldinfo.season;
        seasonLength = worldinfo.seasonLength;
        seasonOffset = worldinfo.seasonOffset;
        beVersion = worldinfo.beVersion;
    }
    ...
    private void updateTagCompound(NBTTagCompound nbttagcompound, NBTTagCompound nbttagcompound1)
    {
        ...
        nbttagcompound.setInteger("season", season);
        nbttagcompound.setInteger("seasonLength", seasonLength);
        nbttagcompound.setInteger("seasonOffset", seasonOffset);
        nbttagcompound.setInteger("beVersion", beVersion);
    }
    ...
    public void setSeasonOffset(int i)
    {
    	seasonOffset = i;
    }
    
    public int getBeVersion()
    {
    	return beVersion;
    }

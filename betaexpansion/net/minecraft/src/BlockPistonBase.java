...
public class BlockPistonBase extends Block
{
    ...
    public void playBlock(World world, int i, int j, int k, int l, int i1)
    {
        ...
        if(l == 1)
        {
            ...
            if(isSticky)
            {
                ...
                if(!flag && j2 > 0 && canPushBlock(j2, world, k1, l1, i2, false) && (Block.blocksList[j2].getMobilityFlag() == 0 
                		|| j2 == Block.pistonBase.blockID || j2 == Block.pistonStickyBase.blockID || j2 == BEBlocks.launcherBase.blockID))
                {
                    field_31048_b = false;
    ...
    private static boolean canPushBlock(int i, World world, int j, int k, int l, boolean flag)
    {
        ...
        if(i == Block.pistonBase.blockID || i == Block.pistonStickyBase.blockID || i == BEBlocks.launcherBase.blockID)
        {
    ...
    private boolean func_31047_i(World world, int i, int j, int k, int l)
    {
        ...
        for(; i1 != i || j1 != j || k1 != k; k1 = l2)
        {
            ...
            if(i3 == blockID && i2 == i && k2 == j && l2 == k)
            {
                ...
                if(blockID == BEBlocks.launcherBase.blockID)
                {
                    world.setBlockTileEntity(i1, j1, k1, BlockPistonMoving.func_31036_a(BEBlocks.launcherExtension.blockID, l | (isSticky ? 8 : 0), l, true, false));
                }else
                {

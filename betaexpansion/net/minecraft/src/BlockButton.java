...
public class BlockButton extends Block
{
    ...
    public boolean isBlockNormalCube(IBlockAccess iblockaccess, int i, int j, int k)
    {
    ...
    {
        if(l == 2 && isBlockNormalCube(world, i, j, k + 1))
        {
            return true;
        }
        if(l == 3 && isBlockNormalCube(world, i, j, k - 1))
        {
            return true;
        }
        if(l == 4 && isBlockNormalCube(world, i + 1, j, k))
        {
            return true;
        }
        return l == 5 && isBlockNormalCube(world, i - 1, j, k);
    }

    public boolean canPlaceBlockAt(World world, int i, int j, int k)
    {
        if(isBlockNormalCube(world, i - 1, j, k))
        {
            return true;
        }
        if(isBlockNormalCube(world, i + 1, j, k))
        ...
        if(isBlockNormalCube(world, i, j, k - 1))
        {
            return true;
        }
        return isBlockNormalCube(world, i, j, k + 1);
    }
    ...
    public void onBlockPlaced(World world, int i, int j, int k, int l)
    {
        ...
        if(l == 5 && isBlockNormalCube(world, i - 1, j, k))
        {
            i1 = 1;
        } else
        {
    ...
    private int getOrientation(World world, int i, int j, int k)
    {
        ...
        return !isBlockNormalCube(world, i, j, k + 1) ? 1 : 4;
    }
    ...
    public void onNeighborBlockChange(World world, int i, int j, int k, int l)
    {
        if(func_305_h(world, i, j, k))
        {
            ...
            boolean flag = false;
            if(!isBlockNormalCube(world, i - 1, j, k) && i1 == 1)
            {
                flag = true;
            }
            if(!isBlockNormalCube(world, i + 1, j, k) && i1 == 2)
            {
                flag = true;
            }
            if(!isBlockNormalCube(world, i, j, k - 1) && i1 == 3)
            {
                flag = true;
            }
            if(!isBlockNormalCube(world, i, j, k + 1) && i1 == 4)
            {
                flag = true;
            }
            if(flag)

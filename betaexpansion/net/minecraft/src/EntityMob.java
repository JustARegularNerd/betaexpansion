    ...
    implements IMob
{
    ...
    {
    	if(worldObj.worldInfo.getSeason() == 3 && worldObj.canBlockSeeTheSky((int)posX, (int)posY, (int)posZ) && 
    			worldObj.getWorldChunkManager().getBiomeGenAt((int)posX, (int)posZ).canSpawnLightningBolt() && worldObj.worldInfo.getRaining())
    	{
    		moveSpeed = origSpeed * 0.5f;
    	}else
    	{
    		moveSpeed = origSpeed;
    	}

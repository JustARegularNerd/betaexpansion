...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiSmallButton(102, (width / 2 - 155) + (i % 2) * 160, height / 6 + 24 * (i >> 1),  "Skin Customization..."));
        controlList.add(new GuiButton(101, width / 2 - 100, height / 6 + 96 + 12, stringtranslate.translateKey("options.video")));
        controlList.add(new GuiSmallButton(100, width / 2, height / 6 + 120 + 12, 100, 20, stringtranslate.translateKey("options.controls")));
        controlList.add(new GuiButton(200, width / 2 - 100, height / 6 + 168, stringtranslate.translateKey("gui.done")));
        controlList.add(new GuiButton(103, width / 2 - 100, height / 6 + 120 + 12, 100, 20, "Texture Packs"));
    }
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        {
            mc.gameSettings.saveOptions();
            mc.displayGuiScreen(new GuiSkinSettings(this, options));
        }
        if(guibutton.id == 101)
        {
            mc.gameSettings.saveOptions();

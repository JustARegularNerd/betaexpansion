    ...
    private void func_31010_a(float f, float f1)
    {
        ...
        if(axisalignedbb != null)
        {
            ...
            if(!list.isEmpty())
            {
                ...
                Entity entity;
                int metaX = PistonBlockTextures.field_31056_b[field_31025_c];
                int metaY = PistonBlockTextures.field_31059_c[field_31025_c];
                int metaZ = PistonBlockTextures.field_31058_d[field_31025_c];
                for(Iterator iterator = field_31018_m.iterator(); iterator.hasNext(); entity.moveEntity(f1 * metaX, f1 * metaY, f1 * metaZ))
                {
                    entity = (Entity)iterator.next();
                	if(worldObj.getBlockId(xCoord-metaX, yCoord-metaY, zCoord-metaZ)==BEBlocks.launcherBase.blockID && field_31024_i)
                	{
                		entity.motionX+=1.2f * metaX;
                		entity.motionY+=1.2f * metaY;
                		entity.motionZ+=1.2f * metaZ;
                	}
                }

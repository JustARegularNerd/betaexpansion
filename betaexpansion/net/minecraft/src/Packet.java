...
public abstract class Packet
{
    ...
    static 
    {
        ...
        addIdClassMapping(231, true, true, net.minecraft.src.Packet231BetaExpansion.class);
        addIdClassMapping(232, true, false, net.minecraft.src.Packet232Season.class);

    ...
    implements IChunkProvider
{
            ...
            for(int l = 0; l < 16; l++)
            {
                ...
                for(int k1 = 127; k1 >= 0; k1--)
                {
                    ...
                    if(j1 == -1)
                    {
                        ...
                        if(k1 >= seaLevel - 4 && k1 <= seaLevel + 1)
                        {
    ...
    private double[] func_4061_a(double ad[], int i, int j, int k, int l, int i1, int j1)
    {
        ...
        field_4181_h = field_921_b.func_4109_a(field_4181_h, i, k, l, j1, 200D, 200D, 0.5D); //depthNoiseScaleX, depthNoiseScaleZ, depthNoiseScaleExponent
        field_4185_d = field_910_m.generateNoiseOctaves(field_4185_d, i, j, k, l, i1, j1, coordinateScale / 80D, heightScale / 160D, coordinateScale / 80D); //mainNoiseScaleX,Y,Z
        field_4184_e = field_912_k.generateNoiseOctaves(field_4184_e, i, j, k, l, i1, j1, coordinateScale, heightScale, coordinateScale);
        field_4183_f = field_911_l.generateNoiseOctaves(field_4183_f, i, j, k, l, i1, j1, coordinateScale, heightScale, coordinateScale);
        int k1 = 0;
        int l1 = 0;
        int i2 = 16 / l;
        for(int j2 = 0; j2 < l; j2++)
        {
            ...
            for(int l2 = 0; l2 < j1; l2++)
            {
                ...
                {
                    double d8 = 0.0D;
                    double d9 = (((double)j3 - d7) * 12D) / d5; //stretchY
                    if(d9 < 0.0D)
                    {
                        d9 *= 4D;
                    }
                    double d10 = field_4184_e[k1] / 512D; //lowerLimitScale
                    double d11 = field_4183_f[k1] / 512D; //upperLimitScale
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        for(int i2 = 0; i2 < 10; i2++)
        {
            ...
            int l8 = rand.nextInt(128);
            int k11 = l + rand.nextInt(16);
            (new WorldGenSponge(24)).generate(worldObj, rand, k5, l8, k11);
        }
        ...
        if(rand.nextInt(10) == 0)
        {
        	for(int x = 0; x < byte1; x++)
        	{
        		int l15 = k + rand.nextInt(16) + 8;
        		int l17 = rand.nextInt(128);
        		int l20 = l + rand.nextInt(16) + 8;
        		(new WorldGenTallGrass(BEBlocks.berryBush.blockID, 2)).generate(worldObj, rand, l15, l17, l20);
        	}
        }
        ...
        if(rand.nextInt(10) == 0)
        {
        	for(int x = 0; x < byte1; x++)
        	{
        		...
        		int l17 = rand.nextInt(128);
        		int l20 = l + rand.nextInt(16) + 8;
        		(new WorldGenTallGrass(BEBlocks.berryBush.blockID, 1)).generate(worldObj, rand, l15, l17, l20);
        	}
        }

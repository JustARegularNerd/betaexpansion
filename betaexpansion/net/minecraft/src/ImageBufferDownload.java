    ...
    implements ImageBuffer
{
    ...
    {
    	isOld = RenderEngine.skinResY != RenderEngine.skinResX;
    	loaded = false;
    }
    ...
    public BufferedImage parseUserSkin(BufferedImage bufferedimage)
    {
    	...
    	tmp = bufferedimage;
    	loaded = true;
    	if(bufferedimage.getHeight() == bufferedimage.getWidth()/2)
    	{
    		isOld = true;
    	}
    ...
    public boolean isOld =  RenderEngine.skinResY != RenderEngine.skinResX;
}

...
public class GuiVideoSettings extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiSmallButton(201, (width / 2 - 155) + (i % 2) * 160, height / 6 + 24 * (i >> 1), "Details..."));
        i++;
        controlList.add(new GuiSmallButton(202, (width / 2 - 155) + (i % 2) * 160, height / 6 + 24 * (i >> 1), "Animations..."));
        i++;
        controlList.add(new GuiSmallButton(203, (width / 2 - 155) + (i % 2) * 160, height / 6 + 24 * (i >> 1), "Particles..."));
        i++;
    }
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        {
            mc.gameSettings.saveOptions();
            mc.displayGuiScreen(new GuiDetails(this, mc.gameSettings));
        }
        if(guibutton.id == 202)
        {
            mc.gameSettings.saveOptions();
            mc.displayGuiScreen(new GuiAnimations(this, mc.gameSettings));
        }
        if(guibutton.id == 203)
        {
            mc.gameSettings.saveOptions();
            mc.displayGuiScreen(new GuiParticles(this, mc.gameSettings));
        }
    ...
    private static EnumOptions field_22108_k[]; 
    {
        field_22108_k = (new EnumOptions[] {
            EnumOptions.GRAPHICS, EnumOptions.RENDER_DISTANCE, EnumOptions.AMBIENT_OCCLUSION, EnumOptions.FRAMERATE_LIMIT, 
            EnumOptions.ANAGLYPH, EnumOptions.VIEW_BOBBING, EnumOptions.GUI_SCALE, EnumOptions.ADVANCED_OPENGL, EnumOptions.FANCYGRASS, EnumOptions.BRIGHTNESS
        });
    }
}

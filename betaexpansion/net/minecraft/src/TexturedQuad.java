...
public class TexturedQuad
{
    ...
    public TexturedQuad(boolean flag, PositionTextureVertex apositiontexturevertex[], int i, int j, int k, int l)
    {
        this(apositiontexturevertex);
        float f = 0.0015625F;
        float f1 = flag ? f : 0.003125f;
        float f2 = flag ? 64f : 32f;
        apositiontexturevertex[0] = apositiontexturevertex[0].setTexturePosition((float)k / 64F - f, (float)j / f2 + f1);
        apositiontexturevertex[1] = apositiontexturevertex[1].setTexturePosition((float)i / 64F + f, (float)j / f2 + f1);
        apositiontexturevertex[2] = apositiontexturevertex[2].setTexturePosition((float)i / 64F + f, (float)l / f2 - f1);
        apositiontexturevertex[3] = apositiontexturevertex[3].setTexturePosition((float)k / 64F - f, (float)l / f2 - f1);
    }

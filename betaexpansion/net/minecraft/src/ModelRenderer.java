...
public class ModelRenderer
{
    ...
    public ModelRenderer(int i, int j, boolean flag)
    {
    	isPlayer = flag;
        compiled = false;
        displayList = 0;
    ...
    public void addBox(float f, float f1, float f2, int i, int j, int k, float f3)
    {
        ...
        faces[0] = new TexturedQuad(isPlayer, new PositionTextureVertex[] {
        ...
        faces[1] = new TexturedQuad(isPlayer, new PositionTextureVertex[] {
        ...
        faces[2] = new TexturedQuad(isPlayer, new PositionTextureVertex[] {
        ...
        faces[3] = new TexturedQuad(isPlayer, new PositionTextureVertex[] {
        ...
        faces[4] = new TexturedQuad(isPlayer, new PositionTextureVertex[] {
        ...
        faces[5] = new TexturedQuad(isPlayer, new PositionTextureVertex[] {

...
public class Block
{
    ...
    {
        if(getBlockHardness(i) < 0.0F)
        {
            return 0.0F;
        }
        if(!entityplayer.canHarvestBlock(this,i))
        {
            return 1.0F / getBlockHardness(i) / 100F;
        } else
        {
            return entityplayer.getCurrentPlayerStrVsBlock(this, i) / getBlockHardness(i) / 30F;
        }
    }
    ...
    {
    	return getBlockProperties(i).blockMaterial;
    }
    
    public StepSound getStepSound(int i)
    {
    	return getBlockProperties(i).stepSound;
    }
    
    public float getBlockResistance(int i)
    {
    	return getBlockProperties(i).blockResistance;
    }
    ...
    static 
    {
        ...
        tilledField = (new BlockFarmland(60, 0)).setHardness(0.6F).setStepSound(soundGravelFootstep).setBlockName("farmland");

...
public class GuiAnimations extends GuiScreen
{
    ...
    public GuiAnimations(GuiScreen guiscreen, GameSettings gamesettings)
    {
        field_22107_a = "Animations";
    ...
    static 
    {
        field_22108_k = (new EnumOptions[] {
            EnumOptions.A_WATERSTILL, EnumOptions.A_WATERFLOW, EnumOptions.A_LAVASTILL, EnumOptions.A_LAVAFLOW, EnumOptions.A_PORTAL, EnumOptions.A_FIRE
        });
    }
}

...
public class GuiCreateWorld extends GuiScreen
{
    ...
    public GuiCreateWorld(GuiScreen guiscreen)
    {
    	...
    	worldSettings = new GuiCustomizeWorld(this);
    }
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(1, width / 2 - 100, height / 4 + 120 + 12, 100, 20, stringtranslate.translateKey("gui.cancel")));
        controlList.add(new GuiButton(2, width / 2, height / 4 + 120 + 12, 100, 20, stringtranslate.translateKey("Customize")));
        ...
        {
        	textboxWorldName.setText(prevName);
        }
        if(prevSeed != null)
        {
        	textboxSeed.setText(prevSeed);
        }
        func_22129_j();
    }
    ...
    protected void actionPerformed(GuiButton guibutton)
    {
        ...
        if(guibutton.id == 2)
        {
        	prevName = textboxWorldName.getText();
        	prevSeed = textboxSeed.getText();
        	mc.displayGuiScreen(worldSettings);
        }
        if(guibutton.id == 0)
        {
    ...
    private GuiCustomizeWorld worldSettings;
    private GuiTextField textboxWorldName;
    private GuiTextField textboxSeed;
    private String folderName;
    private boolean createClicked;
    private String prevSeed;

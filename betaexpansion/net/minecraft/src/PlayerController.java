...
public class PlayerController
{
    ...
    public boolean sendPlaceBlock(EntityPlayer entityplayer, World world, ItemStack itemstack, int i, int j, int k, int l)
    {
        ...
        if(i1 > 0 && (!entityplayer.isSneaking() || (entityplayer.getCurrentEquippedItem() != null && 
        		entityplayer.getCurrentEquippedItem().itemID == BEBlocks.ropeLadder.blockID && 
        		i1 == BEBlocks.ropeLadder.blockID)) && Block.blocksList[i1].blockActivated(world, i, j, k, entityplayer))
        {
            return true;
        }
        if(itemstack == null)

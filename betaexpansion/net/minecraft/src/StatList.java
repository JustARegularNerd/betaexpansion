...
public class StatList
{
    ...
    private static void replaceAllSimilarBlocks(StatBase astatbase[])
    {
        ...
        replaceSimilarBlocks(astatbase, BEBlocks.tilledFieldDry.blockID, Block.dirt.blockID);
        replaceSimilarBlocks(astatbase, BEBlocks.tilledFieldCool.blockID, Block.dirt.blockID);
        replaceSimilarBlocks(astatbase, BEBlocks.tilledFieldWarm.blockID, Block.dirt.blockID);
    }
